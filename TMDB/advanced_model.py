...
class AdvancedTMDBPredictor:
    ...
    def __init__(self):
        self.models = {}
        self.label_encoders = {}
        self.use_log_transform = True  # 使用 log 轉換
        
    def load_data(self):
        """載入資料"""
        print("\n[1/8] 載入資料...")
        self.train_df = pd.read_csv('/kaggle/input/tmdb-box-office-prediction/train.csv')
        self.test_df = pd.read_csv('/kaggle/input/tmdb-box-office-prediction/test.csv')
    ...
    def generate_submission(self, predictions):
        ...
        submission.to_csv('/kaggle/working/submission_advanced.csv', index=False)
