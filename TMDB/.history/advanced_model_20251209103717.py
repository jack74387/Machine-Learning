...
class AdvancedTMDBPredictor:
    ...
    def prepare_features(self):
        ...
        feature_cols = [
            ...
            'actor_revenue_to_budget_ratio', 'director_revenue_to_budget_ratio', 
            'company_revenue_to_budget_ratio',
            
            # 交互特徵
            'budget_x_popularity', 'budget_x_runtime', 'popularity_x_runtime',
            'budget_x_year', 'popularity_x_year', 'budget_x_cast_count',
            'budget_x_has_collection', 'popularity_x_has_collection',
            'budget_x_director_mean', 'budget_x_actor_mean', 'budget_x_company_mean',
            
            # 多項式特徵
            'budget_squared', 'popularity_squared', 'budget_sqrt', 'popularity_sqrt',
            'budget_cubed', 'popularity_cubed',
            
            # 歷史數據特徵
            'top_actor_mean_revenue', 'top_actor_max_revenue', 'top_actor_movie_count',
            'top3_actors_mean_revenue',
            'director_mean_revenue', 'director_max_revenue', 'director_movie_count',
            'top_company_mean_revenue', 'top_company_max_revenue', 'top_company_movie_count',
