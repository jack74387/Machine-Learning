...
| 檔案 | 用途 | 性能 | 推薦度 |
|------|------|------|--------|
| **simple_main.py** | 基礎模型 | R²=0.688 | ⭐⭐ |
| **advanced_model.py** | 進階模型 | R²=0.703 | ⭐⭐⭐⭐⭐ |
| **main.py** | 完整版本 | 需安裝額外套件 | ⭐⭐⭐ |
| **eda_visualization.py** | EDA 視覺化 | 生成6張圖表 | ⭐⭐⭐⭐ |

**使用建議**:
- 初學者：先執行 `simple_main.py`
- 進階用戶：執行 `advanced_model.py` ⭐
- 完整體驗：安裝套件後執行 `main.py`
